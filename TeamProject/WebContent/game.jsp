	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="game.jsp"><i class="fas fa-gamepad"></i>&nbsp;Game</a></li>
		...
		<div class="row">
			<table class="table table-hover"
				...
				<tbody>
					...
					ArrayList<Bbs> listgame = bbsDAO.getListgame(pageNumber);
					for(int i = 0; i < listgame.size(); i++) {
						
					%>
					<tr>
						<td><%= listgame.get(i).getNum() %></td>
						<td><a href="view.jsp?num=<%= listgame.get(i).getNum() %>"><%= listgame.get(i).getTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt").replaceAll("\n", "<br>") %></a></td>
						<td><%= listgame.get(i).getUserID() %></td>
						<td><%= listgame.get(i).getCtg() %></td>
						<td><%= listgame.get(i).getBbsDate().substring(0, 11) + listgame.get(i).getBbsDate().substring(11, 13) + "시" + listgame.get(i).getBbsDate().substring(14, 16) + "분" %></td>
					</tr>
					<%
						}
					%>
