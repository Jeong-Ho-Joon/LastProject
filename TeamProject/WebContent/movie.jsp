	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="movie.jsp"><i class="fas fa-film"></i>&nbsp;Movie</a></li>
		...
		<div class="row">
			<table class="table table-hover"
				...
				<tbody>
					...
					ArrayList<Bbs> listmovie = bbsDAO.getListmovie(pageNumber);
					for(int i = 0; i < listmovie.size(); i++) {
						
					%>
					<tr>
						<td><%= listmovie.get(i).getNum() %></td>
						<td><a href="view.jsp?num=<%= listmovie.get(i).getNum() %>"><%= listmovie.get(i).getTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt").replaceAll("\n", "<br>") %></a></td>
						<td><%= listmovie.get(i).getUserID() %></td>
						<td><%= listmovie.get(i).getCtg() %></td>
						<td><%= listmovie.get(i).getBbsDate().substring(0, 11) + listmovie.get(i).getBbsDate().substring(11, 13) + "시" + listmovie.get(i).getBbsDate().substring(14, 16) + "분" %></td>
					</tr>
					<%
						}
					%>
