	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="bbs.jsp"><i class="fas fa-list"></i>&nbsp;All</a></li>
			...
			<table class="table table-hover"
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="view.jsp?num=<%= list.get(i).getNum() %>"><%= list.get(i).getTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt").replaceAll("\n", "<br>") %></a></td>
						<td><%= list.get(i).getUserID() %></td>
						<td><%= list.get(i).getCtg() %></td>
